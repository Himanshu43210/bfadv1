        ...
        return (
            <div className='menu_popup' onMouseEnter={() => setVisited(true)}>
                ...
                <div className='menu_sec menu_sec_middle'>
                    ...
                    <Link href="/account/tabs?tab=viewed" className='acc_menu_item'>
                        <div className='menu_item'>
                            <VisibilityIcon className='menu_item_icon' />
                            <span>Viewed</span>
                        </div>
                    </Link>
                    <Link href="/account/tabs?tab=contacted" className='acc_menu_item'>
                        <div className='menu_item'>
                            <CallIcon className='menu_item_icon' />
                            <span>Contacted</span>
                        </div>
                    </Link>
                    <Link href="/account/tabs?tab=recommendations" className='acc_menu_item'>
                        <div className='menu_item'>

          ...
          <div className="modal_controls">
            ...
            {onRemove && (
              <Button
                variant="secondary"
                onClick={onRemove}
                className="modal_btn reject_btn"
              >
                Reject
              </Button>
            )}
            ...
            {onHomePreview && (
              <Button
                variant="secondary"
                onClick={onHomePreview}
                className="modal_btn home_preview_btn"
              >
                Home
              </Button>
            )}
            {onDetailPreview && (
              <Button
                variant="secondary"
                onClick={onDetailPreview}
                className="modal_btn preview_btn"
              >
                Card Details
              </Button>
            )}
            {onSearchResultPreview && (
              <Button
                variant="secondary"
                onClick={onSearchResultPreview}
                className="modal_btn search_btn"
              >
                Search
              </Button>
            )}

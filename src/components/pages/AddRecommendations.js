...
import { ADD_RECOMMENDATION, GET_ADMIN_PROPERTY_DATA, LOADING, POST, PROFILE } from '../utils/Const.js';
...
const AddRecommendations = () => {
    ...
    const apiStatus = useSelector((state) => selectApiStatus(state, GET_ADMIN_PROPERTY_DATA || ""));
    const dataApi = ``;
        ...
        <>
            {apiStatus === LOADING ? (
                ...
                <div className="sub_page user_management_page">
                    <Card>
                        <Card.Header className="card_header font">Add Recommendation</Card.Header>

...
export const APP_ROUTES = {
  ...
  "/admin/approveListing": {
    key: "ApproveListingScreen",
    screen: "APPROVAL_PROPERTIES",
  },
  "/admin/customers": {
    key: "CustomerManagement",
    page: "./src/components/pages/CustomerManagement.js",
  },
  "/admin/addRecommendation": {
    key: "AddRecommendations",
    page: "./src/components/pages/AddRecommendations.js",
  },
  "/admin/showRecommended": {
    key: "ShowRecommended",
    page: "./src/components/pages/ShowRecommended.js",
  },
  "/admin/master": {
    key: "MasterManagement",
    page: "./src/components/pages/MasterManagement.js",
  },
  "/admin/masterTable": { key: "SuperMasterTable", screen: "AD_MASTER_TABLE" },
  "/admin/statistics": { key: "StatsScreen", screen: "STATS_LIST" },
  "/admin/statistics/listingData": {
    key: "ViewListingScreen",
    screen: "VIEW_LISTING",
  },
...
export const OTHER_PAGES = {
  ADMIN_DASHBOARD: {
    key: "AdminDashboard",
    page: "./src/components/pages/AdminDashboard.js",
  },
  USER_MANAGEMENT: {
    key: "UserManagement",
    page: "./src/components/pages/UserManagement.js",
  },
  CUSTOMER_MANAGEMENT: {
    key: "CustomerManagement",
    page: "./src/components/pages/CustomerManagement.js",
...
export const COMPONENTS = {
  [LOADING]: {
    ...
    path: "",
    import: `import CircularProgress from "@material-ui/core/CircularProgress/CircularProgress.js";`,
  },
  ...
  [BUTTON]: {
    name: "Button",
    props: { handleOnClick: "handleValueChange", setSliceData: "setSliceData" },
  },
